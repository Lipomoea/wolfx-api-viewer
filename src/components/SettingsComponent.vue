...
const handleAbout = ()=>{
    ElMessageBox.alert(
        ...
        <div class="about">
            <p>v2.0.0 pre16 变更：升级Vue3至最新版本；新增：支持JMA紧急地震速报区域预想震度绘制（震度4及以上）。</p>
            <p>v2.0.0 pre1-pre15 变更：UI重排，WebSocket使用all_eew接口，使用新的中国和日本地图，暂时移除地震波倒计时功能；新增：同源多个EEW同时展示，适配假定震源，中国断层显示，NIED強震モニタ测站显示、震度检出功能，设置默认视野功能，鼠标悬浮提示区域名称，NIED测站回放功能。</p>
        ...
        'wolfx-api-viewer v2.0.0 pre-16',
        {
