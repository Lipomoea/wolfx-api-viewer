<template>
    <div class="outer">
        <div class="container">
            ...
            <div class="about">
                <p>v1.0.4 新增：JMA地震情报支持点击项目跳转详情；优化：同时只弹出一个地图。</p>
                <p>v1.0.3 新增：自动打开地图功能细分；优化：设置选项分类；优化：代码逻辑以更易于维护。</p>
                <p>v1.0.2 新增：地震信息地图显示；修复：地震历史页面刷新404的问题；修复：EEW超时后进入地图异常绘制地震波的问题；优化：地图加载性能。</p>
                <p>v1.0.1 修复：震源图标不更新的bug；优化：对设置选项进行分类；优化：地图加载性能。</p>
                <p>v1.0.0 新增：地震预警信息现在支持地图显示；新增：自动打开地图功能；修复：CENC地震信息异常触发刷新的bug；优化：四川地震局地震预警预估烈度显示为整数。</p>
            </div>
            <div class="title">使用方法</div>
            <div class="about">
                <p>主要功能：接收日本气象厅、台湾省中央气象署、四川省地震局、福建省地震局地震预警信息以及日本气象厅、中国地震台网地震测定信息。点击任一模块打开地图，“地震信息”地图右上角可跳转查看历史地震。</p>
            ...
            <div class="about">
                <p>1. 关于烈度：日本气象厅、台湾省中央气象署资料采用震度制，四川省地震局、福建省地震局、中国地震台网资料采用CSIS烈度制。不同烈度制数值不可直接比较，不同烈度制对应配色逻辑不同。除日本气象厅地震情报外所有烈度数值均为估计值，不代表真实烈度。</p>
                ...
                <p>7. 关于地图：由于服务器带宽限制，进入页面后可能需要一定时间加载地图。如果长时间未加载地图，请刷新页面。</p>
            </div>
            ...
            <div class="about">
                ...
                <p>本页面为个人基于兴趣爱好开发，无任何形式的盈利行为，仅供学习交流使用，无法保证正常维护。</p>
